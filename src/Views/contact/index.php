      ...
      <div class="contact-section reveal" style="--delay: 80ms">
        ...
        <div class="contact-grid">
          <div class="contact-card contact-card--highlight spotlight-card">
            ...
            <div class="contact-actions">
              <?php if (!empty($contact['founder']['portfolio'])): ?>
                <a href="<?= $e($contact['founder']['portfolio']) ?>" class="contact-action-btn" title="Visit Founder Portfolio (fabianternis.de)" target="_blank" rel="noopener noreferrer">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <?php endif; ?>
              <?php if (!empty($contact['founder']['github'])): ?>
                <a href="<?= $e($contact['founder']['github']) ?>" class="contact-action-btn" title="GitHub @fabianternis" target="_blank" rel="noopener noreferrer">
