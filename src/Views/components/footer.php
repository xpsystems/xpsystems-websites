<footer class="site-footer">
  <div class="container footer-inner">
    <div class="footer-brand">
      ...
      <p class="footer-desc"><?= htmlspecialchars($brand['tagline'] ?? 'German Web-Provider') ?> — European infrastructure, digital sovereignty, and privacy-first web services operated from Germany.</p>
  ...
  <div class="container footer-bottom-strip">
    <span>Hosted on European Bare-Metal Infrastructure &bull; Zero Data Brokerage &bull; 100% GDPR / DSGVO Compliant</span>
    <span><?= htmlspecialchars($brand['domains'][0] ?? 'xpsystems.eu') ?> / <?= htmlspecialchars($brand['domains'][1] ?? 'xpsystems.de') ?></span>
  </div>
</footer>
